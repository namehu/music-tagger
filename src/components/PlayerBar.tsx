...
export function PlayerBar() {
  const { currentSong, isPlaying, setPlaying, next, prev, playlist } = usePlayer()
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900 text-white p-4">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-4 ml-4">
          ...
          <button onClick={handlePlayPause} className="text-2xl hover:text-gray-300 w-10 h-10 flex items-center justify-center">
            {isPlaying ? '⏸' : '▶'}
          </button>
